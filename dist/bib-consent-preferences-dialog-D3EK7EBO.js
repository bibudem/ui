...
var _i, _t, _e, _s, _b_instances, o_fn, n_fn;
...
import { D as r } from "./constants-C4fSqP7Z.js";
...
class p {
  ...
  dispatchRequest() {
    this.host.dispatchEvent(new d(this.context, this.t, this.subscribe));
  }
}
const u = "checked", h = "disabled";
const _m = class _m extends HTMLElement {
  constructor() {
    super();
    ...
    __privateAdd(this, _e, () => {
      ...
      return i2.innerHTML = _m.html, e2.appendChild(t2), e2.appendChild(i2.content), e2;
    });
  ...
  attributeChangedCallback(e2) {
    e2 === u && __privateGet(this, _t).call(this, true);
  }
};
_i = new WeakMap();
_t = new WeakMap();
_e = new WeakMap();
__publicField(_m, "defaultElementName", "toggle-switch");
__publicField(_m, "html", '\n        <span part="track">\n            <span part="slider"></span>\n        </span>\n    ');
__publicField(_m, "css", '\n        :host {\n            display: inline-block;\n            width: 2em;\n            height: 1em;\n            cursor: pointer;\n        }\n\n        span {\n            box-sizing: border-box;\n            display: inline-block;\n            line-height: 1;\n        }\n\n        [part="track"] {\n            width: 100%;\n            height: 100%;\n            background-color: #dddddd;\n            text-align: left;\n            transition: all 0.256s;\n        }\n\n        [part="slider"] {\n            width: 50%;\n            height: 100%;\n            background-color: #777777;\n            transition: all 0.256s;\n            vertical-align: text-top;\n        }\n\n        :host([checked]) [part="slider"] {\n            transform: translateX(100%);\n        }\n\n        :host([disabled]) {\n            cursor: not-allowed;\n            opacity: 0.5;\n        }\n    ');
__publicField(_m, "formAssociated", true);
let m = _m;
function g(e2) {
  return Object.keys(r).reduce((t2, i2) => ({ ...t2, [i2]: e2 }), {});
}
window.customElements.get(m.defaultElementName) || window.customElements.define(m.defaultElementName, m);
class b extends e {
  constructor() {
    super();
    __privateAdd(this, _b_instances);
    __publicField(this, "_consentConsumer");
    __privateAdd(this, _s, g(false));
    this.open = false, this._dialogRef = o(), this._consentConsumer = new p(this, { context: a, subscribe: true, callback: (e2) => {
      console.log("callback: ", e2), __privateSet(this, _s, null === e2 ? g(false) : e2);
    } });
  }
  async savePreferences(e2) {
    try {
      let i2;
      i2 = true === (t2 = e2) || false === t2 || c(t2) && "[object Boolean]" == l(t2) ? g(e2) : __privateGet(this, _s), this.dispatchEvent(new CustomEvent("update", { detail: i2 }));
    } catch (e3) {
