 ...
 */
import { n as t } from "./lit-element-DmnF17fR.js";
/**
 * @license
...
class e {
  ...
  _getArgs() {
    if (void 0 === this._argsFn) return;
    const t2 = this._argsFn();
    if (!Array.isArray(t2)) throw new Error("The args function must return an array");
    return t2;
  }
  async _performTask() {
...
//# sourceMappingURL=task-tJdhE5Hn.js.map
