...
import { s as e, i, x as r } from "./lit-element-C-D0oZt5.js";
class s extends e {
  render() {
...
__publicField(s, "styles", i`:host{color:var(--bib-footer-text-color,#fff);display:flex;width:100%;background-color:var(--bib-palette-primary-main,#0057ac)}`);
window.customElements.define("bib-footer-copyright", s);
export {
  s as BibFooterCopyright
};
