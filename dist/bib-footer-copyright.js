...
var c = (e, s, i) => s in e ? o(e, s, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[s] = i;
var r = (e, s, i) => (c(e, typeof s != "symbol" ? s + "" : s, i), i);
import { L as a, c as n, h as l } from "./lit-element-Mznt8OUE.js";
class t extends a {
  render() {
...
r(t, "styles", n`:host{color:var(--bib-footer-text-color,#fff);display:flex;width:100%;background-color:var(--bib-palette-primary-main,#0057ac)}`);
