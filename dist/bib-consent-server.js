...
import l from "./ConsentStorage.js";
class g extends e {
  constructor() {
    super();
  ...
  async init() {
    __privateMethod(this, _g_instances, o_fn).call(this, "Initializing BibConsentServer..."), __privateSet(this, _e, await l()), __privateGet(this, _e).listen((e2) => {
      __privateMethod(this, _g_instances, o_fn).call(this, "Storage updated with data", e2.detail);
    }), __privateMethod(this, _g_instances, o_fn).call(this, "Start listening for storage updates..."), await this.startListening(), __privateMethod(this, _g_instances, o_fn).call(this, "Initialization complete.");
  }
  async startListening() {
    ...
    this.connected = true, __privateMethod(this, _g_instances, o_fn).call(this, "Connected:", `<code class="value">${this.connected}</code>`), __privateMethod(this, _g_instances, o_fn).call(this, "Listening for postMessage events..."), e2(async (e3, t2, o2) => {
      let s2;
      switch (e3) {
        ...
        case "ping":
          ...
          break;
        default:
          throw __privateMethod(this, _g_instances, o_fn).call(this, `Unknown method: <code class="method">${e3}</code>. Payload:`, t2), new Error(`Unknown method: ${e3}`);
      }
      o2(s2);
    });
  }
