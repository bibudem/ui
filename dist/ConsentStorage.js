...
var P = s(g, "DataView"), x = s(g, "Promise"), B = s(g, "Set"), L = "[object Map]", M = "[object Promise]", z = "[object Set]", U = "[object WeakMap]", N = "[object DataView]", V = b(P), W = b(v), I = b(x), R = b(B), q = b(O), F = m;
function G(e2) {
...
(P && F(new P(new ArrayBuffer(1))) != N || v && F(new v()) != L || x && F(x.resolve()) != M || B && F(new B()) != z || O && F(new O()) != U) && (F = function(e2) {
...
function Q(e2, t2, r2, n2, o2, a2) {
  ...
  var l2 = -1, b2 = true, v2 = r2 & K ? new G() : void 0;
...
function ae(e2, t2, r2, n2, o2) {
  return e2 === t2 || (null == e2 || null == t2 || !k(e2) && !k(t2) ? e2 != e2 && t2 != t2 : function(e3, t3, r3, n3, o3, a2) {
    var s2 = l(e3), c2 = l(t3), i2 = s2 ? re : F(e3), u2 = c2 ? re : F(t3), f2 = (i2 = i2 == te ? ne : i2) == ne, b2 = (u2 = u2 == te ? ne : u2) == ne, v2 = i2 == u2;
    if (v2 && w(e3)) {
