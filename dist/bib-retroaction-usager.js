...
}, m = { attribute: true, type: String, converter: e, reflect: false, hasChanged: t }, b = (e2 = m, t2, r2) => {
...
function f(e2) {
  return (t2, r2) => "object" == typeof r2 ? b(e2, t2, r2) : ((e3, t3, r3) => {
...
function g(e2) {
  return f({ ...e2, state: true, attribute: false });
}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const y = (e2, t2, r2) => (r2.configurable = true, r2.enumerable = true, Reflect.decorate && "object" != typeof t2 && Object.defineProperty(e2, t2, r2), r2);
function x(e2, t2) {
  return (t3, r2, o2) => y(t3, r2, { get() {
...
class I {
  ...
  constructor(e2, t2) {
    this.host = e2, this.onControlChange = t2, this.currentControl = null, e2.addController(this), e2[k] = this, z?.observe(e2, { attributeFilter: ["for"] });
  }
  attach(e2) {
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const T = ["focusin", "focusout", "pointerdown"];
class S extends r {
  constructor() {
    super(...arguments), this.visible = false, this.inward = false, this.attachableController = new I(this, this.onControlChange.bind(this));
  }
  get htmlFor() {
...
A.styles = [E], A = p([v("md-focus-ring")], A);
/**
 * @license
...
const L = ["click", "contextmenu", "pointercancel", "pointerdown", "pointerenter", "pointerleave", "pointerup"], O = window.matchMedia("(forced-colors: active)");
class B extends r {
  constructor() {
    super(...arguments), this.disabled = false, this.hovered = false, this.pressed = false, this.rippleSize = "", this.rippleScale = "", this.initialSize = 0, this.state = P.INACTIVE, this.checkBoundsAfterContextMenu = false, this.attachableController = new I(this, this.onControlChange.bind(this));
  }
  get htmlFor() {
    return this.attachableController.htmlFor;
  }
  ...
  render() {
    ...
    return o`<div class="surface ${R(e2)}"></div>`;
  }
  update(e2) {
  ...
  handlePointerleave(e2) {
    this.shouldReactToEvent(e2) && (this.hovered = false, this.state !== P.INACTIVE && this.endPressAnimation());
  }
  handlePointerup(e2) {
  ...
  handleClick() {
    this.disabled || (this.state !== P.WAITING_FOR_CLICK ? this.state === P.INACTIVE && (this.startPressAnimation(), this.endPressAnimation()) : this.endPressAnimation());
  }
  ...
  async endPressAnimation() {
    this.rippleStartEvent = void 0, this.state = P.INACTIVE;
 ...
 */
N.map(q);
const H = Symbol("internals"), D = Symbol("privateInternals");
function G(e2) {
  return class extends e2 {
    get [H]() {
      return this[D] || (this[D] = this.attachInternals()), this[D];
    }
  };
}
/**
...
function U(e2) {
  e2.addInitializer((e3) => {
    ...
    t2.addEventListener("click", async (e4) => {
      const { type: r2, [H]: o2 } = t2, { form: a2 } = o2;
...
j(Z), U(Z), Z.formAssociated = true, Z.shadowRootOptions = { mode: "open", delegatesFocus: true }, p([f({ type: Boolean, reflect: true })], Z.prototype, "disabled", void 0), p([f()], Z.prototype, "href", void 0), p([f()], Z.prototype, "target", void 0), p([f({ type: Boolean, attribute: "trailing-icon", reflect: true })], Z.prototype, "trailingIcon", void 0), p([f({ type: Boolean, attribute: "has-icon", reflect: true })], Z.prototype, "hasIcon", void 0), p([f()], Z.prototype, "type", void 0), p([f({ reflect: true })], Z.prototype, "value", void 0), p([x(".button")], Z.prototype, "buttonElement", void 0), p([/* @__PURE__ */ function(e2) {
  return (t2, r2) => {
...
}({ slot: "icon", flatten: true })], Z.prototype, "assignedIcons", void 0);
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
Q.styles = [J, X, W], Q = p([v("md-filled-button")], Q);
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const te = a`:host{--_container-height:var(--md-text-button-container-height, 40px);--_disabled-label-text-color:var(--md-text-button-disabled-label-text-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-label-text-opacity:var(--md-text-button-disabled-label-text-opacity, 0.38);--_focus-label-text-color:var(--md-text-button-focus-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-label-text-color:var(--md-text-button-hover-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-color:var(--md-text-button-hover-state-layer-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-opacity:var(--md-text-button-hover-state-layer-opacity, 0.08);--_label-text-color:var(--md-text-button-label-text-color, var(--md-sys-color-primary, #6750a4));--_label-text-font:var(--md-text-button-label-text-font, var(--md-sys-typescale-label-large-font, var(--md-ref-typeface-plain, Roboto)));--_label-text-line-height:var(--md-text-button-label-text-line-height, var(--md-sys-typescale-label-large-line-height, 1.25rem));--_label-text-size:var(--md-text-button-label-text-size, var(--md-sys-typescale-label-large-size, 0.875rem));--_label-text-weight:var(--md-text-button-label-text-weight, var(--md-sys-typescale-label-large-weight, var(--md-ref-typeface-weight-medium, 500)));--_pressed-label-text-color:var(--md-text-button-pressed-label-text-color, var(--md-sys-color-primary, #6750a4));--_pressed-state-layer-color:var(--md-text-button-pressed-state-layer-color, var(--md-sys-color-primary, #6750a4));--_pressed-state-layer-opacity:var(--md-text-button-pressed-state-layer-opacity, 0.12);--_disabled-icon-color:var(--md-text-button-disabled-icon-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-icon-opacity:var(--md-text-button-disabled-icon-opacity, 0.38);--_focus-icon-color:var(--md-text-button-focus-icon-color, var(--md-sys-color-primary, #6750a4));--_hover-icon-color:var(--md-text-button-hover-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-color:var(--md-text-button-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-size:var(--md-text-button-icon-size, 18px);--_pressed-icon-color:var(--md-text-button-pressed-icon-color, var(--md-sys-color-primary, #6750a4));--_container-shape-start-start:var(--md-text-button-container-shape-start-start, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-start-end:var(--md-text-button-container-shape-start-end, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-end:var(--md-text-button-container-shape-end-end, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-start:var(--md-text-button-container-shape-end-start, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_leading-space:var(--md-text-button-leading-space, 12px);--_trailing-space:var(--md-text-button-trailing-space, 12px);--_with-leading-icon-leading-space:var(--md-text-button-with-leading-icon-leading-space, 12px);--_with-leading-icon-trailing-space:var(--md-text-button-with-leading-icon-trailing-space, 16px);--_with-trailing-icon-leading-space:var(--md-text-button-with-trailing-icon-leading-space, 16px);--_with-trailing-icon-trailing-space:var(--md-text-button-with-trailing-icon-trailing-space, 12px);--_container-color:none;--_disabled-container-color:none;--_disabled-container-opacity:0}`;
let re = class extends ee {
};
re.styles = [J, te], re = p([v("md-text-button")], re);
/**
 * @license
...
const oe = Symbol.for(""), ae = (e2) => {
  ...
  if (c2 === o2 && n2.push(t2[o2]), d2) {
    ...
    void 0 === (t2 = ne.get(e3)) && (n2.raw = n2, ne.set(e3, t2 = n2)), r2 = s2;
  }
  return e2(t2, ...r2);
})(o);
/**
...
class de extends ce {
  constructor() {
    super(...arguments), this.disabled = false, this.flipIconInRtl = false, this.href = "", this.target = "", this.ariaLabelSelected = "", this.toggle = false, this.selected = false, this.type = "submit", this.value = "", this.flipIcon = le(this, this.flipIconInRtl);
  }
  get name() {
    return this.getAttribute("name") ?? "";
  }
  ...
  render() {
    const e2 = this.href ? ie`div` : ie`button`, { ariaLabel: t2, ariaHasPopup: r2, ariaExpanded: o2 } = this, a2 = t2 && this.ariaLabelSelected, i2 = this.toggle ? this.selected : n;
    let s2 = n;
    return this.href || (s2 = a2 && this.selected ? this.ariaLabelSelected : t2), se`<${e2}
  ...
  connectedCallback() {
    this.flipIcon = le(this, this.flipIconInRtl), super.connectedCallback();
  }
...
pe.styles = [ue, he], pe = p([v("md-outlined-icon-button")], pe);
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
class ve extends r {
  ...
  render() {
    const { ariaLabel: e2 } = this;
    return o`<div class="progress ${R(this.getRenderClasses())}" role="progressbar" aria-label="${e2 || n}" aria-valuemin="0" aria-valuemax="${this.max}" aria-valuenow="${this.indeterminate ? n : this.value}">${this.renderIndicator()}</div>`;
  }
  getRenderClasses() {
    return { indeterminate: this.indeterminate, "four-color": this.fourColor };
  }
}
j(ve), p([f({ type: Number })], ve.prototype, "value", void 0), p([f({ type: Number })], ve.prototype, "max", void 0), p([f({ type: Boolean })], ve.prototype, "indeterminate", void 0), p([f({ type: Boolean, attribute: "four-color" })], ve.prototype, "fourColor", void 0);
/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const ye = a`:host{font-size:var(--md-icon-size,24px);width:var(--md-icon-size,24px);height:var(--md-icon-size,24px);color:inherit;font-variation-settings:inherit;font-weight:400;font-family:var(--md-icon-font,Material Symbols Outlined);display:inline-flex;font-style:normal;place-items:center;place-content:center;line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;user-select:none;white-space:nowrap;word-wrap:normal;flex-shrink:0;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}::slotted(svg){fill:currentColor}::slotted(*){height:100%;width:100%}`;
let xe = class extends ge {
};
xe.styles = [ye], xe = p([v("md-icon")], xe);
...
t_fn = async function(e2) {
  ...
  return new Promise(async (e3, r3) => {
    ...
    this.state = __e.STATES.SUBMITTED;
  }).catch((e3) => {
    this.state = __e.STATES.ERROR, console.error("Vote submission failed. ", e3);
  }).finally(() => {
    t2.disabled = false;
  });
};
