...
var _e, _s_instances, t_fn, i_fn;
import { T as e } from "./task-tJdhE5Hn.js";
import { L as t, c as i, u as n, h as a } from "./lit-element-DmnF17fR.js";
class s extends t {
  constructor() {
    super();
  ...
  render() {
    return __privateGet(this, _e).render({ pending: () => null, complete: ({ bannerType: e2, date: t2, fullDay: i2, headerLink: n2, hour: s2, title: o, url: r }) => (this.href = n2 ?? r, e2 && (this.big = "large" === e2), o && a`<aside class="wrapper${this.big ? " big" : ""}" tabindex="0" @click="${__privateMethod(this, _s_instances, i_fn)}" @keyup="${__privateMethod(this, _s_instances, i_fn)}"><div class="container"><div class="content"><a class="title" href="${this.href}" @click="${__privateMethod(this, _s_instances, t_fn)}" tabindex="-1"><div>${o}</div></a><time datetime="${t2}" class="datetime"><span class="hour">${s2}</span> <span>| </span><span classid="date">${i2}</span></time></div></div></aside>`) });
  }
}
_e = new WeakMap();
...
__publicField(s, "properties", { service: { type: String }, big: { type: Boolean }, href: { type: String, attribute: false } });
...
window.customElements.get("udem-urgence") || window.customElements.define("udem-urgence", s);
export {
  s as UdeMUrgence
};
