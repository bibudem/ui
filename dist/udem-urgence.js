...
import { T as t } from "./task-B50inpYJ.js";
import { L as e, c as i, u as n, h as a } from "./lit-element-DgcYs_ed.js";
class s extends e {
  constructor() {
    super();
  ...
  render() {
    return __privateGet(this, _t).render({ pending: () => null, complete: ({ bannerType: t2, date: e2, fullDay: i2, headerLink: n2, hour: s2, title: o, url: r }) => (this.href = n2 ?? r, t2 && (this.big = "large" === t2), o && a`<aside class="wrapper${this.big ? " big" : ""}" tabindex="0" @click="${__privateMethod(this, _i, i_fn)}" @keyup="${__privateMethod(this, _i, i_fn)}"><div class="container"><div class="content"><a class="title" href="${this.href}" @click="${__privateMethod(this, _e, e_fn)}" tabindex="-1"><div>${o}</div></a><time datetime="${e2}" class="datetime"><span class="hour">${s2}</span> <span>| </span><span classid="date">${i2}</span></time></div></div></aside>`) });
  }
}
_t = new WeakMap();
_e = new WeakSet();
...
customElements.define("udem-urgence", s);
export {
  s as UdeMUrgence
};
