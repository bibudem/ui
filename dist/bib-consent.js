...
var _e, _t, _s, _n, _o, _i, _r, _w_instances, c_fn, h_fn, l_fn, u_fn, a_fn, d_fn, p_fn;
...
import { a as r } from "./bib-BaerflTk.js";
import { d as c } from "./events-BtF7lCmA.js";
import { ConsentTokens as h } from "./ConsentTokens.js";
...
class w extends e {
  constructor() {
    ...
    this.open = false, this.currentDialog = null, __privateSet(this, _i, s()), __privateSet(this, _r, s()), __privateSet(this, _s, new m(this, { context: l, initialValue: new h() })), __privateSet(this, _n, new i(this, { context: l, callback: this.savePreferences }));
  }
  get state() {
    return __privateGet(this, _o);
  }
  async connectedCallback() {
    super.connectedCallback(), this.debug = this.debug || false, this.serverUrl = this.serverUrl || p, this.serverRequestTimeout = this.serverRequestTimeout || b, this._consentClient = await a({ host: this, serverUrl: this.serverUrl, serverRequestTimeout: this.serverRequestTimeout, reflectEvents: true }), this._consentClient.addEventListener(v.READY, (e2) => {
      const { detail: t2 } = e2;
      t2.getState() === d.DETERMINATE ? __privateMethod(this, _w_instances, h_fn).call(this, t2) : __privateMethod(this, _w_instances, a_fn).call(this, "consent"), __privateMethod(this, _w_instances, c_fn).call(this, v.READY, t2.toObject());
    });
  }
  close() {
    __privateMethod(this, _w_instances, u_fn).call(this);
  }
  show() {
  ...
  async saveTokens(e2) {
    __privateMethod(this, _w_instances, l_fn).call(this, "[save] tokens: ", e2);
    const t2 = h.from(e2);
    try {
      return await this._consentClient.setConsentTokens(t2), __privateMethod(this, _w_instances, h_fn).call(this, t2), true;
    } catch (e3) {
  ...
  async resetTokens() {
    ...
    return __privateSet(this, _t, e2), __privateMethod(this, _w_instances, c_fn).call(this, v.CHANGE, e2.toObject()), e2;
  }
  render() {
    return t`<bib-consent-consent-dialog @intern:change="${__privateMethod(this, _w_instances, d_fn)}" @intern:show-preferences="${() => __privateMethod(this, _w_instances, a_fn).call(this, "preferences")}" ${n(__privateGet(this, _i))} @intern:close="${__privateMethod(this, _w_instances, p_fn)}"></bib-consent-consent-dialog><bib-consent-preferences-dialog @intern:change="${__privateMethod(this, _w_instances, d_fn)}" ${n(__privateGet(this, _r))} @intern:close="${__privateMethod(this, _w_instances, p_fn)}"></bib-consent-preferences-dialog>`;
  }
}
_e = new WeakMap();
_t = new WeakMap();
...
u_fn = function(e2 = true) {
  this.open = false, this.currentDialog?.close(e2), this.currentDialog = null, e2 && __privateMethod(this, _w_instances, c_fn).call(this, v.CLOSE);
};
a_fn = function(e2 = "consent") {
  ...
  this.open = true, this.currentDialog && (__privateMethod(this, _w_instances, l_fn).call(this, "[#show] this.currentDialog", this.currentDialog), this.currentDialog.close()), __privateMethod(this, _w_instances, l_fn).call(this, "[show]", __privateGet(this, _i).value), __privateMethod(this, _w_instances, l_fn).call(this, "[show]", __privateGet(this, _r).value), this.currentDialog = "consent" === e2 ? __privateGet(this, _i).value : __privateGet(this, _r).value, this.currentDialog.show();
};
d_fn = async function(e2) {
  if (!await this.saveTokens(e2.detail)) return;
  const t2 = await this.getTokens();
  __privateMethod(this, _w_instances, c_fn).call(this, v.CHANGE, t2), __privateMethod(this, _w_instances, u_fn).call(this);
};
p_fn = function(e2) {
  __privateMethod(this, _w_instances, u_fn).call(this, false);
};
__publicField(w, "properties", { serverUrl: { type: String, attribute: "server-url" }, serverRequestTimeout: { type: Number, attribute: "server-request-timeout" }, [u.LOCAL]: { type: Boolean }, state: { type: String }, debug: { type: Boolean, reflect: true }, open: { type: Boolean, reflect: true } });
window.customElements.get("bib-consent") || window.customElements.define("bib-consent", w), r("consent", {});
export {
  w as BibConsent
};
