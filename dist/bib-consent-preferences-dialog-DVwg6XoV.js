...
var _i, _t, _e, _s, _m_instances, n_fn, o_fn;
...
class m extends e {
  constructor() {
    ...
    this.open = false, this._dialogRef = n(), __privateSet(this, _s, new r(false)), this._consentConsumer = new d(this, { context: a, subscribe: true, callback: (e2) => {
      try {
        const t2 = r.from(e2);
  ...
  async savePreferences(e2) {
    try {
      void 0 !== e2 && __privateGet(this, _s).setAll(e2), this.dispatchEvent(new CustomEvent("intern:change", { detail: __privateGet(this, _s) }));
    } catch (e3) {
