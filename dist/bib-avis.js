...
var _e, _t, _h_instances, s_fn, i_fn, n_fn, o_fn, r_fn;
...
class h extends t {
  constructor() {
    ...
    __publicField(this, "_avisTask", new e(this, { task: async ([e2], { signal: t2 }) => {
      const s2 = new URL(e2), i2 = await fetch(s2, { headers: { Accept: "application/json" }, signal: t2 });
  ...
  connectedCallback() {
    super.connectedCallback(), __privateMethod(this, _h_instances, s_fn).call(this);
  }
  _renderBoutonFermer() {
    return this.boutonFermer ? n`<button class="btn-close" aria-label="Fermer" @click="${__privateMethod(this, _h_instances, r_fn)}">${o('<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-424 284-228q-11 11-28 11t-28-11q-11-11-11-28t11-28l196-196-196-196q-11-11-11-28t11-28q11-11 28-11t28 11l196 196 196-196q11-11 28-11t28 11q11 11 11 28t-11 28L536-480l196 196q11 11 11 28t-11 28q-11 11-28 11t-28-11L480-424Z"/></svg>')}</button>` : null;
  }
  render() {
...
s_fn = function() {
  return new e(this, { task: async ([e2], { signal: t2 }) => {
    const s2 = new Promise(async (s3, i2) => {
      ...
      const n2 = new URL(e2), o2 = await fetch(n2, { headers: { Accept: "application/json" }, signal: t2 }).catch(console.error);
      if (!o2.ok) return i2(new Error(o2.status));
      const { message: r2 } = await o2.json();
      s3({ isLocal: false, message: r2 });
    });
    try {
      const e3 = await s2;
      await __privateMethod(this, _h_instances, i_fn).call(this, e3);
    } catch (e3) {
...
i_fn = async function(e2) {
  ...
  try {
    const s2 = await b(e2), i2 = await t2.get(c, s2);
    i2 ? i2.hidden || (await t2.delete(c, s2), __privateMethod(this, _h_instances, n_fn).call(this, i2)) : __privateMethod(this, _h_instances, n_fn).call(this, e2);
  } catch (t3) {
