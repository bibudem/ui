...
var _e, _t, _d_instances, s_fn, i_fn, n_fn, o_fn, r_fn;
import { T as e } from "./task-tJdhE5Hn.js";
import { L as t, c as s, u as i, h as n } from "./lit-element-DmnF17fR.js";
import { u as o } from "./unsafe-html-tpiIXNZn.js";
import { o as r } from "./index-CRxQMTzC.js";
import { a } from "./bib-BW5s0xHx.js";
import { n as c } from "./package-BBW9ji0a.js";
const l = "avis";
async function h(e2) {
...
class d extends t {
  ...
  connectedCallback() {
    super.connectedCallback(), __privateMethod(this, _d_instances, s_fn).call(this);
  }
  _renderBoutonFermer() {
    return this.boutonFermer ? n`<button class="btn-close" aria-label="Fermer" @click="${__privateMethod(this, _d_instances, r_fn)}">${o('<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-424 284-228q-11 11-28 11t-28-11q-11-11-11-28t11-28l196-196-196-196q-11-11-11-28t11-28q11-11 28-11t28 11l196 196 196-196q11-11 28-11t28 11q11 11 11 28t-11 28L536-480l196 196q11 11 11 28t-11 28q-11 11-28 11t-28-11L480-424Z"/></svg>')}</button>` : null;
  }
  render() {
...
s_fn = function() {
  return new e(this, { task: async ([e2, t2, s2], { signal: i2 }) => {
    ...
    try {
      const e3 = await n2;
      await __privateMethod(this, _d_instances, i_fn).call(this, e3);
    } catch (e3) {
...
i_fn = async function(e2) {
  ...
  const t2 = __privateSet(this, _t, await r(c, 1, { upgrade(e3) {
    e3.objectStoreNames.contains(l) || e3.createObjectStore(l);
  } }));
  try {
    const s2 = await h(e2), i2 = await t2.get(l, s2);
    i2 ? i2.hidden || (await t2.delete(l, s2), __privateMethod(this, _d_instances, n_fn).call(this, i2)) : __privateMethod(this, _d_instances, n_fn).call(this, e2);
  } catch (t3) {
