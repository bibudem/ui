...
import { n as a } from "./package-BhnEHglX.js";
const c = "avis";
async function l(e2) {
...
i_fn = async function(e2) {
  ...
  const t2 = __privateSet(this, _t, await r(a, 1, { upgrade(e3) {
    e3.objectStoreNames.contains(c) || e3.createObjectStore(c);
  } }));
  try {
    const s2 = await l(e2), i2 = await t2.get(c, s2);
    i2 ? i2.hidden || (await t2.delete(c, s2), __privateMethod(this, _d_instances, n_fn).call(this, i2)) : __privateMethod(this, _d_instances, n_fn).call(this, e2);
  } catch (t3) {
...
o_fn = async function() {
  ...
  const e2 = await l(__privateGet(this, _e));
...
window.customElements.get("bib-avis") || window.customElements.define("bib-avis", d);
export {
  d as BibAvis
};
