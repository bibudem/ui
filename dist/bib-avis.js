...
__publicField(h, "properties", { service: { type: String }, contexte: { type: String, default: "site-web" }, niveau: { type: String }, boutonFermer: { type: Boolean, attribute: "bouton-fermer" }, message: { state: true } });
...
window.customElements.get("bib-avis") || window.customElements.define("bib-avis", h);
export {
  h as BibAvis
};
