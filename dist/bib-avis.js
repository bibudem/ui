...
import { a } from "./bib-iGuYwAse.js";
import { n as c } from "./package-BUO2f-K0.js";
const l = "avis";
async function d(e2) {
...
i_fn = async function(e2) {
  ...
  try {
    const s2 = await d(e2), i2 = await t2.get(l, s2);
    i2 ? i2.hidden || (await t2.delete(l, s2), __privateMethod(this, _h_instances, n_fn).call(this, i2)) : __privateMethod(this, _h_instances, n_fn).call(this, e2);
  } catch (t3) {
